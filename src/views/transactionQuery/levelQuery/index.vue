<template>
    <div class="level-cantainer">
        ...
        <el-row >
             <el-col :span="18" style="border:1px solid grey;margin:50px 10%">
                 <div class="grid-content bg-purple-dark">
                    <div class="hei" v-if="top.pnl_permission == true"> 净平仓PNL </div>
                    <div class="hei" v-if="top.pnl_permission == true"> 平仓PNL </div>
                
                    <div class="hei"> 手续费 </div>
                 </div>
                   <div class="grid-content bg-purple-dark">
                    <div class="hei red" v-if="top.pnl_permission == true">  <span>{{top.total_net_pnl}}</span></div>
                    <div class="hei red" v-if="top.pnl_permission == true">  <span>{{top.total_pnl}}</span> </div>
                    <div class="hei red"> <span>{{top.total_commission}}</span> </div>
                 </div>
             </el-col>
        </el-row>
         <el-table
      ...
      <el-table-column label="净PNL" align="center" min-width="90px" v-if="top.pnl_permission==true">
        <template slot-scope="{row}">
            <span>{{row.net_pnl}}</span>
        </template>
      </el-table-column>
      <el-table-column label="PNL" align="center" min-width="90px" v-if="top.pnl_permission==true">
        <template slot-scope="{row}">
            <span>{{row.pnl}}</span>
        </template>
      </el-table-column>
